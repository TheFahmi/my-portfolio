  ...
  return (
    <div className={`absolute w-full overflow-hidden ${className}`} style={{ height, maxWidth: '100%' }}>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden z-10" style={{ maxWidth: '100%' }}>
        ...
        >
          {/* Base wave layer - seamless looping */}
          <motion.path
            d="M0,50 C150,20 300,80 450,50 C600,20 750,80 900,50 C1050,20 1200,80 1200,50 L1200,200 L0,200 Z"
            fill={activeColor}
            animate={{
              d: [
                "M0,50 C150,20 300,80 450,50 C600,20 750,80 900,50 C1050,20 1200,80 1200,50 L1200,200 L0,200 Z",
                "M0,70 C150,40 300,100 450,70 C600,40 750,100 900,70 C1050,40 1200,100 1200,70 L1200,200 L0,200 Z",
                "M0,50 C150,20 300,80 450,50 C600,20 750,80 900,50 C1050,20 1200,80 1200,50 L1200,200 L0,200 Z",
              ],
            }}
            transition={{
          ...
          {/* Second wave layer - seamless looping */}
          <motion.path
            d="M0,80 C150,50 300,110 450,80 C600,50 750,110 900,80 C1050,50 1200,110 1200,80 L1200,200 L0,200 Z"
            fill={isDarkMode ? "rgba(59, 130, 246, 0.4)" : "rgba(37, 99, 235, 0.15)"}
            animate={{
              d: [
                "M0,80 C150,50 300,110 450,80 C600,50 750,110 900,80 C1050,50 1200,110 1200,80 L1200,200 L0,200 Z",
                "M0,100 C150,70 300,130 450,100 C600,70 750,130 900,100 C1050,70 1200,130 1200,100 L1200,200 L0,200 Z",
                "M0,80 C150,50 300,110 450,80 C600,50 750,110 900,80 C1050,50 1200,110 1200,80 L1200,200 L0,200 Z",
              ],
            }}
            transition={{
          ...
          {/* Third wave layer - seamless looping */}
          <motion.path
            d="M0,100 C150,70 300,130 450,100 C600,70 750,130 900,100 C1050,70 1200,130 1200,100 L1200,200 L0,200 Z"
            fill={isDarkMode ? "rgba(59, 130, 246, 0.2)" : "rgba(37, 99, 235, 0.1)"}
            animate={{
              d: [
                "M0,100 C150,70 300,130 450,100 C600,70 750,130 900,100 C1050,70 1200,130 1200,100 L1200,200 L0,200 Z",
                "M0,120 C150,90 300,150 450,120 C600,90 750,150 900,120 C1050,90 1200,150 1200,120 L1200,200 L0,200 Z",
                "M0,100 C150,70 300,130 450,100 C600,70 750,130 900,100 C1050,70 1200,130 1200,100 L1200,200 L0,200 Z",
              ],
            }}
            transition={{
